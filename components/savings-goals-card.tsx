...
export function SavingsGoalsCard({ goals, onAddGoal }: SavingsGoalsCardProps) {
  ...
  return (
    <>
      ...
      <AddSavingsGoalModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} onAdd={handleAddGoal} />
    </>
  )
}
